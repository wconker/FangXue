...
public class ContactListFist extends BaseActivity implements MessageCallBack {
        ...
        observer = new Observer<String>() {
            ...
            public void onNext(String s) {
                ...
                if (JSONUtils.getString(cmd, "cmd").equals("parent.selectstudent")) {
                    ...
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "headerimg", JSONUtils.getString(studentObj, "headerimg")); //头像信息
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "studentName", JSONUtils.getString(studentObj, "studentname")); //用户信息
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "studentSchoolnm", JSONUtils.getString(studentObj, "schoolnm")); //用户信息
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "studentClassname", JSONUtils.getString(studentObj, "classname")); //用户信息
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "parentname", JSONUtils.getString(studentObj, "parentname")); //家长姓名
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "relationship", JSONUtils.getString(studentObj, "relationship")); //家长关系
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "mobile", JSONUtils.getString(studentObj, "mobile")); //家长电话
                    SharedPrefsUtil.putValue(ContactListFist.this, "userXML", "studentid", JSONUtils.getString(studentObj, "studentid")); //用户信息

                    startActivity(new Intent(ContactListFist.this, ActivityCenter.class));
                    finish();
                }
            }
        };
