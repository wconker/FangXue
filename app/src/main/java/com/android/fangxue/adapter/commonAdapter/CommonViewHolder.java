...
public class CommonViewHolder {
     ...
     * @return 返回ViewHolder
     */
    public CommonViewHolder setList(final OnMyListClick onMyListClick, Context  context, int viewId, int layoutId, int viewId1, int viewId2, List<Map<String, Object>> strs) {
       lv=getView(viewId);
        lv.setAdapter(new SimpleAdapter(context,strs,layoutId, new String[] { "name", "pay"},new int[] {viewId1,viewId2}));
   ...
   public interface  OnMyListClick{
